package shiyu.learn.selectcitytrain.activities;
...
import shiyu.learn.selectcitytrain.R;
import shiyu.learn.selectcitytrain.binding.Bind;
import shiyu.learn.selectcitytrain.binding.ViewBinder;
import shiyu.learn.selectcitytrain.model.CityEntity;
import shiyu.learn.selectcitytrain.utils.JsonReadUtil;
import shiyu.learn.selectcitytrain.utils.ScreenUtils;
import shiyu.learn.selectcitytrain.utils.ToastUtils;
import shiyu.learn.selectcitytrain.view.LetterListView;

public class MainActivity extends Activity implements AbsListView.OnScrollListener {
    private ScreenUtils mScreenUtils=new ScreenUtils(MainActivity.this);
    private ToastUtils mToastUtils=new ToastUtils(MainActivity.this);
    ...
    private void initView() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            int top = mScreenUtils.getSystemBarHeight();
                    ...
                    curCityNameTv.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            if (!locationCity.equals(curSelCity)) {
                                ...
                                mToastUtils.show("当前定位城市" + curCityNameTv.getText().toString());
                            }
                        }
                    });
                }
...
//        }
    ...
    private void showSetCityDialog(final String curCity, final String cityCode) {
        if (curCity.equals(curSelCity)) {
            mToastUtils.show("当前定位城市" + curCity);
            return;
        }
